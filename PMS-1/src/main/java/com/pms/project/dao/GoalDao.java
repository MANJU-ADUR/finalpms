...
public class GoalDao {
	...
	public List<Goal> bymanagerid(Long managerid){
		return goalsRepository.findByManager_id(managerid);
	}
	public List<Goal> byhrid(Long hrid){
		return goalsRepository.findByHr_id(hrid);
	}
}
